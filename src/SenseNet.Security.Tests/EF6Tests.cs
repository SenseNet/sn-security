//UNDONE: Review the additional tests in this class and rewrite them in the EFCSecurityStore.Tests
...
//        {
//            var providerAcc = new PrivateObject((EF6SecurityDataProvider)DataProvider);
